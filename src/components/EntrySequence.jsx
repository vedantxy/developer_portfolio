  ...
  return (
    ...
    >
      <div className="w-full max-w-[200px] space-y-4 text-center">
        ...
        <div className="h-[1px] w-full relative overflow-hidden" style={{ background: 'var(--border)' }}>
          <motion.div 
  ...
  return (
    ...
    >
      <div className="text-center space-y-6">
        ...
        <div className="overflow-hidden">
          <motion.p
            ...
            className="text-sm md:text-lg font-bold uppercase tracking-[0.5em]"
            style={{ color: 'var(--text-secondary)' }}
          >
            {role}
          </motion.p>
        ...
        <motion.div 
          ...
          className="h-px w-24 mx-auto origin-center"
      ...
      <motion.span 
        ...
        className="absolute inset-0 flex items-center justify-center text-[40vw] font-black pointer-events-none"
        style={{ color: 'var(--text-primary)' }}
      >
        V
      </motion.span>
...
const EntrySequence = ({ children }) => {
  ...
  return (
    <div className="fixed inset-0 z-[1000]" style={{ background: 'var(--bg-primary)' }}>
